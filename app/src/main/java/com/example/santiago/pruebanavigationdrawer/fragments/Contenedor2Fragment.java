...
import com.example.santiago.pruebanavigationdrawer.adapters.SeccionesAdapter;
 ...
 * {@link Contenedor2Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Contenedor2Fragment#newInstance} factory method to
...
public class Contenedor2Fragment extends Fragment {
     ...
     * @return A new instance of fragment Contenedor2Fragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(Utilidades.rotacion==0) {
            ...
            if (appBar == null) {
                ...
                //pestañas.setTabTextColors(Color.parseColor("#00DAAA"), Color.parseColor("#00DAAA"));
                pestañas.setTabTextColors(Color.parseColor("#FFFFFF"), Color.parseColor("#FFFFFF"));
                pestañas.setSelectedTabIndicatorColor(Color.parseColor("#FFFFFF"));
    ...
    private void llenarViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new AgregarAlimentoFragment(), "ALIMENTOS");
        adapter.addFragment(new WaterFragment(), "AGUA");
        adapter.addFragment(new IMCFragment(), "IMC");
